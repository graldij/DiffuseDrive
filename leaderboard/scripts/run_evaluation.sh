...
export TEAM_AGENT=leaderboard/team_code/DiffuseDrive_agent.py # agent
export TEAM_CONFIG=leaderboard/team_code/DiffuseDrive_config.py # model checkpoint, not required for expert
