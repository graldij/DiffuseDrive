...
class GaussianDiffusionCarla(nn.Module):
    def __init__(self, model, horizon, observation_dim, n_timesteps=1000,
        loss_type='l1', clip_denoised=False, predict_epsilon=True,
        loss_discount=1.0, loss_weights=None, returns_condition=False,
        condition_guidance_w=0.1,):
        ## MOD: delete action_dim, action_weight for get_loss_weights
        ## MOD: no transition_dim
        super().__init__()
    ...
    @torch.no_grad()
    def conditioning(x, cond, history_dim):
        return
